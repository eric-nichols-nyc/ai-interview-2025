...
export interface TimerComponentHandle {
  start: () => void;
  pause: () => void;
  reset: () => void;
}
...
export const TimerComponent = forwardRef<
  TimerComponentHandle,
  TimerComponentProps
>(({ mode, initialMinutes, initialSeconds, compact, onComplete }, ref) => {
  ...
  const [inputSeconds, setInputSeconds] = useState(
    (typeof initialSeconds === "number" ? initialSeconds : 0).toString()
  );
  ...
  useImperativeHandle(
    ...
    [mode, countdownStart, initialMinutes, initialSeconds]
  );
  ...
  useEffect(() => {
    ...
    if (mode === "up") {
      setTime(newInitial);
      setInputMinutes(
        (typeof initialMinutes === "number" ? initialMinutes : 0).toString()
      );
      setInputSeconds(
        (typeof initialSeconds === "number" ? initialSeconds : 0).toString()
      );
      ...
      setInputMinutes(
        (typeof initialMinutes === "number" ? initialMinutes : 1).toString()
      );
      setInputSeconds(
        (typeof initialSeconds === "number" ? initialSeconds : 0).toString()
      );
              ...
              <>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    {time === 0 ? "Time's up!" : "Countdown Mode"}
                  </p>
                </div>
              </>
            )}
