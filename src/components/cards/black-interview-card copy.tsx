  ...
  return (
    <Card className="black-bg p-8 rounded-lg shadow-lg max-w-2xl mx-auto border-2 border-white/20">
      ...
      <CardContent>
        ...
        <div className="px-4 py-2 border rounded-full border-zinc-700 text-zinc-200">may</div>
        <div className="px-4 py-2 border rounded-full border-zinc-700 text-zinc-200">jun</div>
        <div className="px-4 py-2 border rounded-full border-zinc-700 text-zinc-200">jul</div>
        <div className="px-4 py-2 border rounded-full border-zinc-700 text-zinc-200">aug</div>
        <div className="px-4 py-2 border rounded-full border-zinc-700 text-zinc-200">sep</div>
